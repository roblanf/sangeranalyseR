...
<img src="`r file.path(params$outputDir, sub('\\.ab1$', '', basename(params$SangerRead@readFileName)), "Chromatogram.pdf")`" alt="some text"  width="100%" height="100%">
...
`r if(!is.null(params$navigationContigFN)){paste0('<br><br><a style="margin-left:-20px" href="', params$navigationContigFN, '" class="btn btn-success btn-block btn-lg active" role="button">Back to Contig Report</a>')}`
