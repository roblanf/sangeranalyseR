...
for (i in 1:length(params$forwardReadFN)){
   cat('\n<div class="row">')
   cat('<a role="button" class="btn btn-success" href="', params$forwardReadFN[[i]], '">Go to</a>\n') 
   cat('\n</div>') 
}
```
...
for (i in 1:length(params$reverseReadFN)){
   cat('\n<div class="row">')
   cat('<a role="button" class="btn btn-success" href="', params$reverseReadFN[[i]], '">Go to</a>\n') 
   cat('\n</div>') 
}
```
