...
```{r echo=FALSE, warning=FALSE}
AAString <- data.frame(AAString(primaryAASeqS1(params$SangerRead)))
...
```{r echo=FALSE, warning=FALSE}
AAString <- data.frame(AAString(primaryAASeqS2(params$SangerRead)))
...
```{r echo=FALSE, warning=FALSE}
AAString <- data.frame(AAString(primaryAASeqS3(params$SangerRead)))
