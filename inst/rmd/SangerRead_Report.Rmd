...
chromatogram(hetcalls,
             ...
             showcalls = "both", filename = file.path(params$outputDir, sub('\\.ab1$', '', basename(params$SangerRead@readFileName)), "Chromatogram.pdf"))
```

<br>
<br>
[Click Here to Open Chromatogram in New Page ](`r file.path(params$outputDir, sub('\\.ab1$', '', basename(params$SangerRead@readFileName)), "Chromatogram.pdf")`)

![Alt](`r file.path(params$outputDir, sub('\\.ab1$', '', basename(params$SangerRead@readFileName)), "Chromatogram.pdf")`){width=100% height=500px}.
