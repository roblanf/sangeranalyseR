...
<div style="overflow: scroll;">
```{r results='asis', echo=FALSE, warning=FALSE}
if (is.null(params$SangerAlignment@contigsTree)) {
  cat("<p style='font-size: 13px; font-weight:bold'> The number of contigs is less than 3, so tree is not created. </p>")
} else {
